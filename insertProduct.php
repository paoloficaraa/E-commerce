        ...
        <div class="container">
            <div class="row wow fadeInUp" data-wow-delay=".4s">
                    <div class="col-lg-6 offset-lg-3 col-md-8 offset-md-2 col-12">
                        <div class="form-head">
                            <form action="checkInsert.php" method="post" class="mt-4 form-text">
                                <div class="form-group">
                                    <label for="" style="font-size: large">Name: </label>
                                    <input type="text" name="name" id="" placeholder="Name" class="form-control">
                                </div>
                                <br>
                                <div class="form-group">
                                    <label for="" style="font-size: large">Description: </label>
                                    <textarea name="description" id="" cols="30" rows="10" placeholder="Description" class="form-control"></textarea>
                                </div>
                                <br>
                                <div class="form-group">
                                    <label for="" style="font-size: large">Price: </label>
                                    <input type="number" name="price" id="" placeholder="Price" class="form-control">
                                </div>
                                <br>
                                <div class="form-group">
                                    <label for="" style="font-size: large">Quantity: </label>
                                    <input type="number" name="quantity" id="" placeholder="Quantity" class="form-control">
                                </div>
                                <br>
                                <div class="form-group">
                                    <label for="" style="font-size: large">Thumbnail: </label>
                                    <input type="text" name="thumbnail" id="" placeholder="Thumbnail" class="form-control">
                                </div>
                                <br>
                                ...
                                <div class="form-group">
                                    <div class="search-btn button">
                                        <button type="submit" class="btn form-control"><i class='bi bi-box-arrow-in-up'></i> Add product</button>
                                    </div>
                                </div>
                            </form>
                        </div>
