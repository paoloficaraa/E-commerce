          ...
          <div class="form-head">
            ...
            <form action="checkRegistration.php" method="post" class="mt-4 form-text">
              <div class="form-group" style="text-align: center">
                ...
                <br />
                <input type="text" name="username" style="width: 300px; height: 35px; font-size: large" />
              </div>
              <br />
              <div class="form-group" style="text-align: center">
                <label style="font-size: large">Password</label>
                <br />
                <input type="password" name="password" style="width: 300px; height: 35px; font-size: large" />
              </div>
              <br />
